...
PATH_ROOT_CNF="${PATH_SSL}/ca.settings.$(hostname).cnf"
PATH_ROOT_CRT="${PATH_SSL}/ca.settings.$(hostname).crt"
PATH_ROOT_KEY="${PATH_SSL}/ca.settings.$(hostname).key"
...
BASE_CNF="
    [ ca ]
    default_ca = ca_settings_$(hostname)

    [ ca_settings_$(hostname) ]
    dir           = $PATH_SSL
    certs         = $PATH_SSL
